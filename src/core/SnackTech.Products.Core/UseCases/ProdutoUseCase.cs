...
internal static class ProdutoUseCase
{
        ...
        ProdutoGateway produtoGateway)
    {
        try
        {
            ...
            if (produto != null)
                return GeralPresenter.ApresentarResultadoErroLogico<ProdutoDto>(
                    $"Produto {produtoDto.Nome} já cadastrado.");
            ...
            var retorno = novoProduto
                ...
                : GeralPresenter.ApresentarResultadoErroLogico<ProdutoDto>(
                    $"Não foi possível cadastrar produto {entidade.Nome}.");
    ...
    internal static async Task<ResultadoOperacao<ProdutoDto>> EditarProduto(Guid identificacao,
        ProdutoSemIdDto produtoDto, ProdutoGateway produtoGateway)
    {
        try
        {
            ...
            if (produto == null)
                return GeralPresenter.ApresentarResultadoErroLogico<ProdutoDto>(
                    $"Produto {identificacao} - {produtoDto.Nome} não encontrado. Atualização não executada!");
    ...
    internal static async Task<ResultadoOperacao> RemoverProduto(Guid identificacao, ProdutoGateway produtoGateway)
    {
        try
        {
            ...
            if (produto == null)
                return GeralPresenter.ApresentarResultadoErroLogico(
                    $"Produto {identificacao} não encontrado. Remoção não executada!");
    ...
    internal static async Task<ResultadoOperacao<IEnumerable<ProdutoDto>>> BuscarProdutoPorCategoria(
        int categoriaProduto, ProdutoGateway produtoGateway)
    {
        try
        {
        ...
        {
            return GeralPresenter.ApresentarResultadoErroLogico<IEnumerable<ProdutoDto>>(
    ...
    internal static async Task<ResultadoOperacao<ProdutoDto>> BuscarProdutoPorIdentificacao(Guid identificacao,
        ProdutoGateway produtoGateway)
    {
        try
        {
            ...
            if (produto == null)
                return GeralPresenter.ApresentarResultadoErroLogico<ProdutoDto>(
                    $"Produto {identificacao} não encontrado.");
