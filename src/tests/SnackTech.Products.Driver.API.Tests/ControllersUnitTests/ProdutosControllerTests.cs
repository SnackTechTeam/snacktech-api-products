...
namespace SnackTech.Products.Driver.API.Tests.ControllersUnitTests
{
    public class ProdutosControllerTestes
    {
        ...
        {
            // Arrange
            var novoProduto = new ProdutoSemIdDto { Nome = "Produto Teste", Descricao = "Descricao Teste", Categoria = 1, Valor = 10.0m };
            var produtoDto = new ProdutoDto { IdentificacaoProduto = Guid.NewGuid(), Nome = "Produto Teste", Descricao = "Descricao Teste", Categoria = 1, Valor = 10.0m };
        ...
        public async Task Put_DeveRetornarOkResult_QuandoProdutoForEditadoComSucesso()
        {
            ...
            var produtoEditado = new ProdutoSemIdDto { Nome = "Produto Editado", Descricao = "Descricao Editada", Categoria = 1, Valor = 15.0m };
            var produtoDto = new ProdutoDto { IdentificacaoProduto = identificacao, Nome = "Produto Editado", Descricao = "Descricao Editada", Categoria = 1, Valor = 15.0m };
            var resultadoOperacao = new ResultadoOperacao<ProdutoDto>(produtoDto);
        ...
        public async Task GetByCategory_DeveRetornarOkResult_QuandoProdutosForemEncontrados()
        {
            // Arrange
            var categoriaId = 1;
            var produtos = new List<ProdutoDto> { new ProdutoDto { IdentificacaoProduto = Guid.NewGuid(), Nome = "Produto 1", Descricao = "Descricao 1", Categoria = 1, Valor = 10.0m } };
