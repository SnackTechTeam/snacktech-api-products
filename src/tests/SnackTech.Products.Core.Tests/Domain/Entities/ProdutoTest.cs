...
namespace SnackTech.Products.Core.Tests.Domain.Entities;
...
public class ProdutoTest
{
    ...
    public void Produto_Construtor_NaoAceitaIdNulo()
    {
        Assert.Throws<ArgumentException>(() =>
            new Produto(null, CategoriaProdutoValido.Acompanhamento, "nome", "descricao", 10.99m));
    }
    ...
    {
        Assert.Throws<ArgumentException>(() =>
            new Produto(Guid.NewGuid(), CategoriaProdutoValido.Acompanhamento, "", "descricao", 10.99m));
        Assert.Throws<ArgumentException>(() =>
            new Produto(Guid.NewGuid(), CategoriaProdutoValido.Acompanhamento, "   ", "descricao", 10.99m));
    }
    ...
    {
        Assert.Throws<ArgumentException>(() =>
            new Produto(Guid.NewGuid(), CategoriaProdutoValido.Acompanhamento, "nome", "descricao", -1));
    }
    ...
    public void Produto_Atualizar_NaoAceitaNomeVazio()
    {
        ...
        Assert.Throws<ArgumentException>(() =>
            produto.Atualizar(CategoriaProdutoValido.Acompanhamento, "", "descricao", 10.99m));
        Assert.Throws<ArgumentException>(() =>
            produto.Atualizar(CategoriaProdutoValido.Acompanhamento, "   ", "descricao", 10.99m));
    }
    ...
    public void Produto_Atualizar_NaoAceitaValorMenorOuIgualAZero()
    {
        ...
        Assert.Throws<ArgumentException>(() =>
            produto.Atualizar(CategoriaProdutoValido.Acompanhamento, "nome", "descricao", -1));
    }
