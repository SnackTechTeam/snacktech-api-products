...
namespace SnackTech.Products.Core.Tests.Gateways;
...
public class ProdutoGatewayTest
{
    ...
    public void ConverterParaEntidade_DeveRetornarProduto_ComDadosCorretos()
    {
        ...
        {
            Id = Guid.NewGuid(), Categoria = CategoriaProdutoValido.Bebida, Nome = "nome", Descricao = "descricao",
            Valor = 10.99m
        };
    ...
    [Fact]
    public async Task
        ProcurarProdutoPorNome_DeveRetornarProduto_SePesquisarPorNomeAsync_DoDataSource_RetornarProdutoDto()
    {
        // Arrange
        var nome = new StringNaoVaziaOuComEspacos("nome");
        var produtoDto = new ProdutoDto
    ...
    [Fact]
    public async Task
        ProcurarProdutoPorIdentificacao_DeveRetornarProduto_SePesquisarPorIdentificacaoAsync_DoDataSource_RetornarProdutoDto()
    {
        // Arrange
        var identificacao = new GuidValido(Guid.NewGuid());
        var produtoDto = new ProdutoDto
    ...
    [Fact]
    public async Task
        ProcurarProdutoPorIdentificacao_DeveRetornarNull_SePesquisarPorIdentificacaoAsync_DoDataSource_RetornarNull()
    {
        // Arrange
        var identificacao = new GuidValido(Guid.NewGuid());
        Mock.Arrange(() => _dataSource.PesquisarPorIdentificacaoAsync(Arg.IsAny<Guid>()))
    ...
    [Fact]
    public async Task
        RemoverProduto_DeveRetornarFalse_SeRemoverProdutoPorIdentificacaoAsync_DoDataSource_RetornarFalse()
    {
        // Arrange
        var id = Guid.NewGuid();
    ...
    [Fact]
    public async Task
        ProcurarProdutosPorCategoria_DeveRetornarProdutos_SePesquisarPorCategoriaIdAsync_DoDataSource_RetornarProdutos()
    {
        // Arrange
        var categoria = CategoriaProdutoValido.Acompanhamento;
    ...
    [Fact]
    public async Task
        ProcurarProdutosPorCategoria_DeveRetornarProdutosVazios_SePesquisarPorCategoriaIdAsync_DoDataSource_RetornarProdutosVazios()
    {
        // Arrange
        var categoria = CategoriaProdutoValido.Acompanhamento;
        Mock.Arrange(() => _dataSource.PesquisarPorCategoriaIdAsync(Arg.IsAny<int>()))
